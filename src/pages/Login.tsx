  ...
  return (
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <h2 className="text-3xl font-bold text-ash-900">Welcome back</h2>
          <p className="mt-2 text-ash-600">Sign in to your CurrencyFuse account</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-ash-200 p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                />
                <label htmlFor="remember-me" className="ml-2 block text-sm text-ash-700">
                  Remember me
                </label>
              </div>
              <div className="text-sm">
                              <a href="#" className="font-medium text-ash-600 hover:text-ash-500">
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-ash-600">
              ...
              <Link to="/signup" className="font-medium text-ash-600 hover:text-ash-500">
                Sign up for free
              </Link>
            </p>
          </div>
